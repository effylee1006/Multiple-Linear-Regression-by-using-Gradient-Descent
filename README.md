...
找出使得代價函數最小的一系列參數，而在利用梯度下降法來找解的過程，參數修正的方向是要往梯度的反方向走才能朝極小值得方向，參數才會往損失函數最小化的地方前進，進而找到最佳參數解![image](https://user-images.githubusercontent.com/97490448/149321881-989b37fd-d409-4b83-a044-d1f692a6c32c.png)
